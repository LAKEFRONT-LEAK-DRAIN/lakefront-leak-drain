...
# THE TWO-LINE SCRUBBER FIX
# Step 1: Revert any existing &amp; back to & so we have a clean slate
# Step 2: Convert all & symbols to &amp; to satisfy XML rules
new_item = new_item.replace('&amp;', '&') 
new_item = new_item.replace('&', '&amp;')

# 4. THE "FORCE-TO-TOP" INJECTION
# This reads the file and inserts the new post ABOVE the first old one
