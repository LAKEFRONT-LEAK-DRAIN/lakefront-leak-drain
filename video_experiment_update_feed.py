...
VIDEO_FEED_FILE = os.environ.get("VIDEO_FEED_FILE", "video_feed_experiment.xml").strip() or "video_feed_experiment.xml"
VIDEO_FEED_PATH = BASE_DIR / VIDEO_FEED_FILE
VIDEO_PAGE_DIR = os.environ.get("VIDEO_PAGE_DIR", "video").strip() or "video"
...
USE_GEMINI_GENERATED_VIDEO = os.environ.get("USE_GEMINI_GENERATED_VIDEO", "true").strip().lower() == "true"
