...
def build_gemini_video_prompt(title, description, cta):
    ...
    prompt_parts = [
        ...
        "Hook requirement: CRITICAL: first 1 to 2 seconds must show an EXTREME CLOSE-UP of the actual plumbing problem (active drain backup overflowing, standing water in sink, clogged toilet bowl, active leak stream, or water pooling) with no people visible.",
        ...
        "ZERO PEOPLE: do NOT show any people, hands, faces, body parts, or silhouettes. The video must be 100% inanimate plumbing objects, water, equipment, and fixtures only.",
