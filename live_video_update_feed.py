...
def build_gemini_video_prompt(title, description, cta):
    prompt_parts = [
        ...
        "Stability requirement: no morphing, warping, or shape-shifting of pipes, fixtures, drains, toilets, or tools between adjacent shots.",
        "Stability requirement: maintain object continuity for materials, geometry, and scale across cuts.",
